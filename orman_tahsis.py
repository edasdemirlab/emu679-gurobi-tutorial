...
# =============================================================================
# model.update() # once update edelim
...
# degiskenlerle ilgili sonuclari bir dataframe'de toplayalim
x_ij_results_df = pd.DataFrame(columns=['var_name', 'analiz_alani_id', 'recete_id',  'basis_status', 'value', 'obj_coef', 'reduced_cost', 'smallest_coef', 'largest_coef',  ])
counter = 0
for v in x_ijk.values():
    ...
    current_var.extend([v.VBasis, round(v.X, 4),   round(v.obj, 4), round(v.RC, 4), round(v.SAObjLow, 4), round(v.SAObjUp, 4)])
...
# Kisitlarla ilgili sonuclari bir data frame'de toplayalim
